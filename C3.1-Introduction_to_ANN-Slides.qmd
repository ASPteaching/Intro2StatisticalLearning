...
- Given a sigmoid AF, the squared error loss [*is  not a convex problem*](https://towardsdatascience.com/why-not-mse-as-a-loss-function-for-logistic-regression-589816b5e03c) so that MSE is not appropriate.
...
knitr::include_graphics("images/2.1-Introduction_to_ANN-Slides_insertimage_4.png")
```
...
![Source: Introducción al Deep Learning (UOC)](images/2.1-Introduction_to_ANN-Slides_insertimage_18.png)
