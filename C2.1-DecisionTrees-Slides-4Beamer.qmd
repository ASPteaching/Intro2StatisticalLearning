...
## General context review: The Prediction Problem.
...
Assuming we wish to controll tree growth there are distinct possible approaches:
...
-   Trees obtained by looking for optimal splits tend to overfit: 
  ...
  - bad for generalizitaon and 
  - tend to fail more  in predictions.
...
CART uses the followin strategy for building optimal trees
