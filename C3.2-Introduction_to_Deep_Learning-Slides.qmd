...
- Given a small patch (a small sub-image, also called a *filter* or *kernel*)

- The goal is to check where it appears inside a larger image. 

- Instead of comparing every pixel individually, there is an operation that may systematically scans the image and measure how well the patch matches different regions.
