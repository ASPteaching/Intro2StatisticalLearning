...
- In 2006  techniques enabling learning in Deep Neural Nets (DNNs) were developed. 

- These were based on stochastic gradient descent and backpropagation, but also introduce new ideas.

- Equiped with such techniques, DNNs perform much better on many problems than shallow NNs.
